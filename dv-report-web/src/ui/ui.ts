...
class UI {
    ...
    setTitleAndSubtitle(cohortNumber: number) {
        ...
        let subtitle = `⚠️ The Decentralized Voices program was <strong><a href="https://x.com/Web3foundation/status/2003436552522015036" target="_blank">terminated</a> by the Web3 Foundation at the end of the fifth cohort.</strong> This report only takes into account the <strong>votes submitted before block number <a href="https://polkadot.subscan.io/block/12723876" target="_blank">12723876</a> on Kusama, and <a href="https://polkadot.subscan.io/block/11238661" target="_blank">11238661</a> on Polkadot,</strong> the final block on each network in which the delegations were revoked.<br><br><strong>This software is now archived,</strong> and does not index current OpenGov data.<br><br>`;
        subtitle +=
            cohortNumber == 4
                ? 'The fourth cohort of the Decentralized Voices program by the Web3 Foundation was <a href="https://medium.com/web3foundation/decentralized-voices-cohort-4-delegates-announced-a5a9c64927fd" target="_blank">announced</a> on the 27th of March, 2025, and the on-chain delegations were dispatched on the 14th of April, 2025. The <span class="bold">delegates are Permanence DAO, The Kus DAO, PolkaWorld, Trustless Core, JAM Implementers DAO (JID), and Polkadot Hungary DAO</span>. The delegates are represented by their short names on the charts for convenience. Green represents <span class="vote-legend aye">aye</span> votes, gray represents <span class="vote-legend abstain">abstain</span>, and red represents <span class="vote-legend nay">nay</span>.'
                : 'The fifth cohort of the Decentralized Voices program by the Web3 Foundation was <a href="https://medium.com/web3foundation/decentralized-voices-cohort-5-announced-45fbf1c017ad" target="_blank">announced</a> on the 19th of August, 2025, and the on-chain delegations were dispatched on the 1st of September, 2025. The <span class="bold">delegates are Polkadot Poland DAO, Reeeeeeeeee DAO, PBA Alumni Voting DAO, Saxemberg, Permanence DAO, Trustless Core, Le Nexus, Flez, Cybergov, Daniel Olano, GoverNoun AI, and The White Rabbit</span>. The delegates are represented by their short names on the charts for convenience. Green represents <span class="vote-legend aye">aye</span> votes, gray represents <span class="vote-legend abstain">abstain</span>, and red represents <span class="vote-legend nay">nay</span>.';
        subtitle +=
