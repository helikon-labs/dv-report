...
class UI {
    ...
    setTitleAndSubtitle(cohortNumber: number) {
        ...
        subtitle +=
            '&nbsp;This application is powered by <strong><a href="https://github.com/paritytech/subxt" target="_blank">SubXT</a></strong>, and <strong><a href="https://subsquare.io/" target="_blank">Subsquare</a></strong> API.';
